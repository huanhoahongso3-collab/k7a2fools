...
public class ThanhBaoVeEntity extends Monster {
	public ThanhBaoVeEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(K7a2FoolsModEntities.THANH_BAO_VE.get(), world);
	}

	public ThanhBaoVeEntity(EntityType<ThanhBaoVeEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public static AttributeSupplier.Builder createAttributes() {
		...
		builder = builder.add(Attributes.ATTACK_DAMAGE, 56);
		builder = builder.add(Attributes.FOLLOW_RANGE, 56);
		builder = builder.add(Attributes.KNOCKBACK_RESISTANCE, 56);
		builder = builder.add(Attributes.ATTACK_KNOCKBACK, 56);
		return builder;
	}
}